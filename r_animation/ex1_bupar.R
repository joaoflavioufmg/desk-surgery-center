...
event_log <- read.csv("C:/Users/user/Desktop/desk/results/ex1_event_log.csv")
...
if ("priority" %in% names(event_log)) {
  ...
  priority_mapping <- c("0" = "Maquinas", "1" = "Emergency", "2" = "Urgent",
...
time_range <- attr(ex1_log, "time_range")
...
htmlwidgets::saveWidget(final_animation, "ex1_visualization.html", selfcontained = TRUE)
