...
def build_model(final_simulation_time=None, event_logger=None, verbose=True,
    ...
    def distribution(tipo):
        ...
        distributions = {            
            ...
            '2_adm_e_conf_paciente': random.triangular(18, 20, 22),
            ...
            '2_adm_paciente': random.triangular(10, 12, 14),
            ...
            '3_checklist_pre_cir': random.triangular(4, 5, 6),
            ...
            '5_limpeza_local': random.triangular(8, 10, 12),
