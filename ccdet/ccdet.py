...
# ================================================================
# desk-sim -m ccdet/ccdet.py --mode visualization
# desk-sim -m ccdet/ccdet.py --mode single
# desk-sim -m ccdet/ccdet.py --mode replications
# desk-sim -m ccdet/ccdet.py --mode factorial
...
def build_model(final_simulation_time=None, event_logger=None, verbose=True,
    ...
    def distribution(tipo):
        ...
        arrival_rate_cc  = 1/120 # per minute        
        ...
        distributions = {            
            ...
            '2_adm_e_conf_paciente': random.triangular(10, 25, 30),
            ...
            '3_ato_anestetico': random.triangular(20, 55, 90),            
    ...
    Enfermeiro = model.add_resource("Enfermeiro", 2, "regular") 
    Farmacia = model.add_resource("Farmacia", 1, "regular") 
    Tec_Enfermagem = model.add_resource("Tec_Enfermagem", 12, "regular") 
    Eq_Assistencial_CTI = model.add_resource("Eq_Assistencial_CTI", 1, "regular") 
    Eq_Medica = model.add_resource("Eq_Medica", 4, "regular")     
    Anestesista = model.add_resource("Anestesista", 2, "regular")    
    ...
    Eq_Higienizacao = model.add_resource("Eq_Higienizacao", 1, "regular") 
    ...
    for block in [arrivals_cc, prep_sala_P16, prep_sala_P2, prep_sala_P3a9,
                  ...
                  proc_materiais_P40aP44, discharge_srpa
                  ]:
    ...
    origem_paciente_decision.add_route("Pac_CTI", adm_conf_paciente_P11a, probability=0.1)
    origem_paciente_decision.add_route("Pac_Outros", adm_conf_paciente_P11b, probability=0.9)
    ...
    limpeza_organizacao_P39.connect_to(proc_materiais_P40aP44)
